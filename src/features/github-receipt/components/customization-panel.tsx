    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 gap-2 max-h-[40vh] overflow-y-auto px-2 pt-1 pb-6 [&::-webkit-scrollbar]:hidden"
        >
